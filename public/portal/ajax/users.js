...
function editOnclick(id)
{
    ...
    $("#phone").val(jsonData[cat].phone);
    $("#businessaddress").val(jsonData[cat].businessaddress);
    $("#businessname").val(jsonData[cat].businessname);
    $("#town").val(jsonData[cat].town);
    $("#lga").val(jsonData[cat].lga);
    $("#state").val(jsonData[cat].state);
}
